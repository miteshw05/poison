...
sleep 1
while true; do
  echo -e "\n\t\t\t1.Payload Tools\t\t\t2.IP Tools\t\t\t3.Steganography Tools\t\t\t4.Check For Updates"
 read m
 case $m in
	[1]* )
while true; do
...
case $lf in
	...
	* ) echo "Select Proper Value"; break;;
	...
	sleep 3
wget -q  --spider https://github.com/miteshw05/poison/blob/master/poison%20V1.3.sh
if [ $? -eq 0 ];
	then
	sleep 2
